...
playauthenticate.reset_password.message.instructions_sent=Las instrucciones de como resetear su contraseña han sido enviadas a {0}.
playauthenticate.reset_password.message.email_not_verified=Su cuenta aún no ha sido validada. Se ha enviado un email incluyedo instrucciones para su validación. Intente resetear la cuenta una vez lo haya recibido.
...
playauthenticate.password.login.unknown_user_or_pw=Usuario o contraseñas desconocidas.
...
playauthenticate.login.password.repeat=Repita lo contraseña elegida
...
playauthenticate.verify.account.before=Antes de configurar una contraseña debe
...
playauthenticate.merge.accounts.question=¿Desea unir si cuenta ({0}) con su otra cuenta: {1}?
...
playauthenticate.link.account.question=¿Enlazar ({0}) con su usario?
playauthenticate.link.account.true=Sí, ¡enlaza esta cuenta!
playauthenticate.link.account.false=No, salir y crear un nuevo usario con esta cuenta
...
playauthenticate.password.forgot.title=Contraseña ovlidada
playauthenticate.password.forgot.cta=Enviar instrucción para restablecer la contraseña
...
playauthenticate.index.intro_2=Esto es una plantilla para una aplicación sencilla con autentificación
playauthenticate.index.intro_3=Mire la barra de navegación superior para ejemplos sencillos incluyendo las características soportadas de autentificación.
